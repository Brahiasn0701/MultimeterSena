...
final class preparedSQL
{
    ...
    const queryReferenceForFunctionPriceAndMaker = "SELECT * FROM reference INNER JOIN function_has_reference ON reference.REFERENCE_ID = function_has_reference.REFERENCE_REFERENCE_ID WHERE function_has_reference.FUNCTION_FUNCTION_ID = ? AND reference.maker_MAKER_ID = ? AND reference.REFERENCE_PRICE BETWEEN ? AND ?";
    const queryReferenceForFunctionPrecisionAndPrice = "SELECT * FROM reference INNER JOIN function_has_reference ON reference.REFERENCE_ID = function_has_reference.REFERENCE_REFERENCE_ID WHERE function_has_reference.FUNCTION_FUNCTION_ID = ? AND function_has_reference.FUNCTION_PRECISION = ? AND reference.REFERENCE_PRICE BETWEEN ? AND ?";
    const queryReferenceForFunctionPrecisionMakerAndPrice = "SELECT * FROM reference INNER JOIN function_has_reference ON reference.REFERENCE_ID = function_has_reference.REFERENCE_REFERENCE_ID WHERE function_has_reference.FUNCTION_FUNCTION_ID = ? AND function_has_reference.FUNCTION_PRECISION = ? AND reference.maker_MAKER_ID = ? AND reference.REFERENCE_PRICE BETWEEN  ? AND ?";
